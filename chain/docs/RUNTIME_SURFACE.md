...
- `Currency = Balances`, `CoinbaseSink = Shielded`, `ShieldedSupply = pallet_shielded::ShieldedSupply<Runtime>`, `FindAuthor = QpowAuthor`, `MaxSupply = 21_000_000 * UNIT`, `EmissionDivisor = 5_000_000`, `Unit = UNIT`. Credits are aligned to the pool quantum (`AMOUNT_SCALE_DOWN_FACTOR` = 10^10).
