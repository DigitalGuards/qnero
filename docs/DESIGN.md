...
| M12 | Project site at `qnero.io` | PLANNED 2026-09-14 (one static site carrying what Qnero is and what it refuses to be, the design and circuit documents, the node download and the one-line miner configuration, and the links to Qloak at `wallet.qnero.io` and silQ Road at `explorer.qnero.io`) |
